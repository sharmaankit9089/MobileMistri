"""
Static content for MobileMistri. Edit this file to update brands, models,
cities, services, FAQs, pricing without changing any other code.
"""
...
FAQ = [
    ...
    {"q": "Which cities do you serve?",
     "a": "Delhi, Noida, Gurgaon, Ghaziabad, Faridabad, Hyderabad, Bangalore, Pune and Mumbai — with more cities launching soon."},
...
# Ensure every brand offers an "Other / Not listed" model fallback
for _b in BRANDS:
    if "Other model (specify)" not in _b["models"]:
        _b["models"].append("Other model (specify)")
